...
The results support the primary research question: **Information flow analysis with explainable machine learning can improve both accuracy and interpretability of USD-NGN forecasts**, thoug improvements remain modest in absolute terms, consistent with exchange rate forecasting literature.
